...
<%@ taglib prefix="s" uri="/struts-tags"%>
    ...
    */
	...
	<body>
	<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 竞赛信息管理<span class="c-gray en">&gt;</span> 队伍管理<span class="c-gray en">&gt;</span> 所有队员信息 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
	<div class="page-container">
		<div class="text-c">
			
		</div>
		<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a  class="btn btn-primary upload-btn"><i class="Hui-iconfont">&#xe642;</i> 参加'   <s:property value="#session.contestNameprocess"/>'    所有队员信息</a></span> <span class="r"><strong>提示：表格右上方可以对信息进行检索  </strong></span> </div>
		<div class="mt-20">
			<table class="table table-border table-bordered table-bg table-sort" id="batchloadInfo">
				...
				<tbody>
				 <s:iterator value="#session.AllPersonInTeamOfContest" var="AllPersonInTeamOfContest"> 
					<tr class="text-c">
						<td><input name="" type="checkbox" value=""></td>
						<td><s:property value="#AllPersonInTeamOfContest.CId" /></td>
						<td><s:property value="#AllPersonInTeamOfContest.CContestName" /></td>
						<td><s:property value="#AllPersonInTeamOfContest.CTeamName" /></td>
						<td class="text-l"><s:property value="#AllPersonInTeamOfContest.CStuName" /></td>
						<td class="text-l"><s:property value="#AllPersonInTeamOfContest.CChecked" /></td>
