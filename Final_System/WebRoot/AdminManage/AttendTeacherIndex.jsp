...
<title>学科竞赛管理系统后台</title>
<meta name="keywords" content="H-ui.admin ">
<meta name="description" content="H-ui.admin ">
</head>
<body>
<s:set name="manageMessage" value="#session.manageMessage"></s:set>
  
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="AdminIndex.jsp">学科竞赛管理系统后台</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" ></a> 
		...
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				...
				<li class="dropDown dropDown_hover">
					<s:property value="#manageMessage.CName"/>
		...
		<dl id="menu-product">
			...
			<dd>
				<ul>
					...
					<li><a data-href="StudentInfoAdd.jsp" data-title="添加学生" href="javascript:void(0)">添加学生信息</a></li>
					<li><a data-href="TeacherInfoAdd.jsp" data-title="添加教师" href="javascript:void(0)">添加教师信息</a></li>
					<li><a data-href="AdminGetAllStudentInfo.action" data-title="学生管理" href="javascript:void(0)">查看学生信息</a></li>
					<li><a data-href="AdminGetAllTeacherInfo.action" data-title="教师管理" href="javascript:void(0)">查看教师信息</a></li>			
