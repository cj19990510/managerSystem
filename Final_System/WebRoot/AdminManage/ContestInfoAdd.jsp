...
<div class="page-container">
	<form class="form form-horizontal" id="form-article-add" action="AdminAddSingleContestInfo" method="post" enctype="multipart/form-data">
			...
			<div class="tabCon">
				...
				<div class="row cl">
					...
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="ContestName" name="contest.CName"  class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						竞赛级别：</label>
					<div class="formControls col-xs-8 col-sm-9">
					    <select class="input-text" name="contest.CLevel" placeholder="请输入竞赛级别">
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						主办方：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="ContestSP" placeholder="" name="contest.CSponsorUnit" value="" class="input-text">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						承办方：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="ContestOR" placeholder="" name="contest.COrganizerUnit" value="" class="input-text">
					</div>
				</div>
				...
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						报名截止日期：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="text" id="ContestDate" placeholder="" name="contest.CTime" value="" class="input-text">
					</div>
				</div>
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">
						...
						赛事图片：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<input type="file" name="upload" id="website-copyright" placeholder="&copy; 2016 H-ui.net"  value="" class="input-text">
					</div>
				</div>
				
				<div class="row cl">
					<label class="form-label col-xs-4 col-sm-2">赛事介绍：</label>
					<div class="formControls col-xs-8 col-sm-9">
						<textarea class="textarea" id="ContestIntro" name="contest.CIntroduction"></textarea>
					</div>
				</div>
			</div>
...
function cheInput(){
    ...
    var ContestSP = document.getElementById('ContestSP');
    var ContestOR = document.getElementById('ContestOR');
    var ContestDate = document.getElementById('ContestDate');
    var ContestIntro = document.getElementById('ContestIntro');
    if(ContestName.value.length==0){
    alert("竞赛名称--不能为空");
    }
    if(ContestSP.value.length==0){
    alert("竞赛主办--不能为空");
    }
    if(ContestOR.value.length==0){
    alert("竞赛承办--不能为空");
    }
    if(ContestDate.value.length==0){
    alert("竞赛日期--不能为空");
    }
    if(ContestIntro.value.length==0){
    alert("竞赛介绍--不能为空");
    }
