...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i><a href="body.jsp">首页</a> <span class="c-gray en">&gt;</span> 参赛经验分享  <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
			...
			<tbody>
			 <s:iterator value="#session.studentAllWorks" var="studentAllWorks"> 
				<tr class="text-c">
					...
					<td><a  target="_blank" href="EchartsGetContestName.action?echartsParameter=<s:property value="#studentAllWorks.CContestName" />"><s:property value="#studentAllWorks.CContestName" /></a></td>
					...
					<td class="text-l"><s:property value="#studentAllWorks.CAttendTeacherName" /></td>
				<td class="f-14">&nbsp;&nbsp;&nbsp;&nbsp;<a href="StudentGetWorkMessage.action?workMessage.CId=<s:property value="#studentAllWorks.CId"/>&workMessage.CStuName=<s:property value="#studentAllWorks.CStuName"/>">查看参赛经验</a></td>
