...
<link rel="stylesheet" type="text/css"
	href="css/contest_css/bootstrap.css">
<link rel="stylesheet" type="text/css"
	href="css/contest_css/font-awesome.min.css">
<link rel="stylesheet" type="text/css" href="css/contest_css/common.css">
<link rel="stylesheet" type="text/css"
	href="css/contest_css/examMng/core.css">
...
<body>
	...
	<s:set name="StudentGetSingleContest"
		value="#session.StudentGetSingleContest"></s:set>
	<!--body begin-->
	<form>
		<div class="main-container">
			<div class="container body-box" style="width:980px;height:670px;">
				<!-- 大背景框 大小 -->
				...
				<div class="content-box" style="width:980px;height:430px;">
					<div class="overflow" style="width:980px;height:430px;">
						<div class="col-lg-10 col-md-10" style="padding:0;width:570px;">
							<!-- 文本框 的大小 -->

							<div class="input-group input-group-lg tk-title">
								<span class="input-group-addon" id="sizing-addon1">&nbsp;&nbsp;&nbsp;竞赛名称</span>
								<input
									value="<s:property value="#StudentGetSingleContest.CName"/>"
									readonly unselectable="on" type="text" class="form-control"
							...
							<div class="input-group input-group-lg tk-title">
								...
								<input
									value="<s:property value="#StudentGetSingleContest.CLevel"/>"
									readonly unselectable="on" type="text" class="form-control"
									placeholder="" aria-describedby="sizing-addon1"
									onblur="tijiao(this)">
							</div>
							...
							<div class="input-group input-group-lg tk-title">
								...
								<input
									value="<s:property value="#StudentGetSingleContest.CSponsorUnit"/>"
									readonly unselectable="on" type="text" class="form-control"
									placeholder="" aria-describedby="sizing-addon1"
									onblur="tijiao(this)">
							</div>
							...
							<div class="input-group input-group-lg tk-title">
								...
								<input
									value="<s:property value="#StudentGetSingleContest.COrganizerUnit"/>"
									readonly unselectable="on" type="text" class="form-control"
									placeholder="" aria-describedby="sizing-addon1"
									onblur="tijiao(this)">
							</div>
							...
							<div class="input-group input-group-lg tk-title tk-introduction">
								...
								<textarea type="text" class="form-control" placeholder=""
									readonly unselectable="on" aria-describedby="sizing-addon1"
									onblur="tijiao(this)"><s:property value="#StudentGetSingleContest.CIntroduction"/></textarea>
							</div>
						</div>

						<div class="col-lg-2 col-md-2"
							style="padding-right:0; height:100px;">
							<a href="javascript:file_upload.click()"> <img
								onclick="prewImg(this)" style="height:320px;;width:350px;"
								src="<s:property value="#StudentGetSingleContest.CPicture"/>">
					...
					<div class="tipbox">
						<span class="tip">提示：</span> <span>详细信息请见赛事官网</span>
					</div>
		...
		<div class="modal-dialog" style="width: 300px">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="text-center">不能为空</div>
				</div>
				<!--删除body结束-->
				<!--删除footer开始-->
